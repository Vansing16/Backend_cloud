...
<form action="/admin/create/messages/store" method="POST">
    @csrf
        ...
        <div class="div">
            ...
            <div class="frame-35376">
                <div class="frame-35544">
                    ...
                    <input type="text" class="frame-3605 form-control" name="contact_info" placeholder="Enter contact info (optional)">
                </div>
