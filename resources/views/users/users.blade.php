                    ...
                    <div class="table">
                        ...
                        @foreach ($users as $user)
                            <div class="table-child">
                                <div class="frame-36022">
                                    <div class="frame-360">
                                        <div class="name-3 valign-text-middle inter-medium-manatee-16px">{{ $user->first_name }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="name-3 valign-text-middle inter-medium-manatee-16px">{{ $user->last_name }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="number-3 valign-text-middle inter-medium-manatee-16px">{{ $user->id }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="user-2 valign-text-middle h6-16px-regular-inter">User</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="jackgmaicom-3 valign-text-middle h6-16px-regular-inter">{{ $user->email }}</div>
                                    </div>
                                    <div class="frame-360-last">
                                        <div class="dropdown">
                                            <button class="dropbtn">...</button>
                                            <div class="dropdown-content">
                                                <a href="{{ route('admin.users.edit', ['id' => $user->id, 'type' => 'user']) }}">Edit</a>
                                                <a href="#" onclick="event.preventDefault(); document.getElementById('delete-user-{{ $user->id }}').submit();">Delete</a>
                        ...
                        @foreach ($admins as $admin)
                            <div class="table-child">
                                <div class="frame-36022">
                                    <div class="frame-360">
                                        <div class="name-3 valign-text-middle inter-medium-manatee-16px">{{ $admin->name }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="name-3 valign-text-middle inter-medium-manatee-16px"> </div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="number-3 valign-text-middle inter-medium-manatee-16px">{{ $admin->id }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="admin-2 valign-text-middle h6-16px-regular-inter">Admin</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="jackgmaicom-3 valign-text-middle h6-16px-regular-inter">{{ $admin->email }}</div>
                                    </div>
                                    <div class="frame-360-last">
                                        <div class="dropdown">
                                            <button class="dropbtn">...</button>
                                            <div class="dropdown-content">
                                                <a href="{{ route('admin.users.edit', ['id' => $admin->id, 'type' => 'admin']) }}">Edit</a>
                                                <a href="#" onclick="event.preventDefault(); document.getElementById('delete-admin-{{ $admin->id }}').submit();">Delete</a>
                        ...
                        @foreach ($freelancers as $freelancer)
                            <div class="table-child">
                                <div class="frame-36022">
                                    <div class="frame-360">
                                        <div class="name-3 valign-text-middle inter-medium-manatee-16px">{{ $freelancer->first_name }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="name-3 valign-text-middle inter-medium-manatee-16px">{{ $freelancer->last_name }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="number-3 valign-text-middle inter-medium-manatee-16px">{{ $freelancer->id }}</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="freelancer-2 valign-text-middle h6-16px-regular-inter">Freelancer</div>
                                    </div>
                                    <div class="frame-360">
                                        <div class="jackgmaicom-3 valign-text-middle h6-16px-regular-inter">{{ $freelancer->email }}</div>
                                    </div>
                                    <div class="frame-360-last">
                                        <div class="dropdown">
                                            <button class="dropbtn">...</button>
                                            <div class="dropdown-content">
                                                <a href="{{ route('admin.users.edit', ['id' => $freelancer->id, 'type' => 'freelancer']) }}">Edit</a>
                                                <a href="#" onclick="event.preventDefault(); document.getElementById('delete-freelancer-{{ $freelancer->id }}').submit();">Delete</a>
                                                <form id="delete-freelancer-{{ $freelancer->id }}" action="{{ route('admin.users.destroy', $freelancer->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
