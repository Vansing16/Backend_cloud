        ...
        <div class="admin-sign-in screen">
            <div class="overlap-group2">
                ...
                <div class="sign-in-header sign-in-1">
                    <img class="icon18pxfacebook" src="{{ asset('img/icon-18px-facebook@2x.png') }}"
                        alt="icon/18px/facebook" />

                </div>
                <div class="sign-in-form sign-in-1">
                    <form method="POST" action="{{ route('admin.signup.post') }}">
                        @csrf
                        <input class="form-fieldregular-boarder-1" type="text" name="name" placeholder="Name"
                            value="{{ old('name') }}" required>
                        <input class="form-fieldregular-boarder-1" type="email" name="email" placeholder="Email"
                            value="{{ old('email') }}" required>
                        <input class="form-fieldregular-boarder-1" type="password" name="password"
                            placeholder="Current password" required>
                        <button type="submit" class="sign-in-form-1">
                ...
                <div class="sign-in-header-1">
                    ...
                    <div> <a href="{{ route('admin.signin') }}" style="text-decoration-color: red">Click here Sign in page here sir</a></div>
